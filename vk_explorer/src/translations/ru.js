...
export const TRANSLATIONS_RU = {
    ...
    analytics: {
        ...
        info: {
            activityHeatmap: "Показывает активность сообщений по часам дня и дням недели. Каждая ячейка представляет количество сообщений, отправленных в этот период времени во всех анализируемых чатах.",
            topContacts: "Ранжирует всех пользователей (включая вас как 'Вы') по общему количеству отправленных сообщений. Показывает самых активных участников во всех анализируемых чатах.",
            messageTimeline: "Показывает активность сообщений во времени, позволяя увидеть периоды высокой и низкой активности в ваших чатах. Помогает выявить закономерности и тренды общения.",
            interactionNetwork: "Тепловая карта, показывающая взаимодействия между топ-10 пользователями. Диагональные ячейки показывают общее количество сообщений каждого пользователя. Недиагональные ячейки показывают общие сообщения между пользователями в общих чатах.",
            responseTime: "Измеряет, как быстро пользователи отвечают на сообщения от других. Учитывает только реалистичное время ответа (от 1 минуты до 24 часов) и ранжирует пользователей по их средней скорости ответа.",
            wordCloud: "Показывает наиболее часто используемые слова во всех сообщениях. Фильтрует обычные слова и слова короче 3 символов. Размер шрифта отражает частоту использования.",
            emojiAnalysis: "Анализирует закономерности использования эмодзи во всех сообщениях. Показывает самые популярные эмодзи с количеством использований и процентными долями частоты."
        }
    },
